...
\end{quote}
The University of Bath has certainly experienced an increase in detected use of ``unfair means'' (the plrase used in Regulations). There is probably a larger increase in undetected use of unfair means.
\section{JHD's experiences}
In this period, JHD has eben teaching two modules with examinations.
\begin{description}
\item[CM30070---Computer Algebra]A module aimed at senior-year mathematicians and computer scientists, based on the author's updated draft version (given to students) of \cite{Davenportetal1988}. This had always had a {\bf Trad-C} examination.
\item[CM50209--Cybersecurity]A module aimed at MSC Computer science students, but taken by others as well.  
\end{description}

\section{Conclusion}
\citet{Cricketal2020d}
\bibliography{../../../jhd}
\end{document}
\section{}
\begin{description}
