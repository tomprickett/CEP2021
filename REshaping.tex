...
\item[Trad-O-R]As above but students can bring in specified paper resources: often called ``open book''. That specification could be very precise: ``A clean copy of the fifth edition of \dots'', or as vague as ``a binder of own notes''.  In practice invigilators find this hard to enforce in a large examination.
