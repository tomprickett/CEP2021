...
rates can be high, with students learning programming for perhaps the first time
remaining a significant
challenge~\cite{davenport-et-al:latice2016,murphy-et-al:programming2017,simon-et-al:sigcse2018};
new priority areas such as cybersecurity~\cite{crick-et-al:fie2020};
as well as a range of issues impacting failure
rates~\cite{Watson:2014:FRI:2591708.2591749,prickett-et-al:iticse2020}. Student
satisfaction as measured by major national surveys is reported as commonly
...
The workshop  at \textanon{UKICER'20}{BLINDED Location}, focused upon
addressing three research questions:\\

%\begin{enumerate}
\noindent {\emph{i)}} What current and future opportunities are there to engage new faculty with a UK CS Education Community of Practice?\\
\noindent {\emph{ii)}} What is the potential to supplement institutional development opportunities with national development opportunities?\\
\noindent {\emph{iii)}} How can we continue to raise the profile and value of new research faculty members engaging with computer science education research?\\
%\end{enumerate}
...
\noindent\textbf{Motivation to attend.} Early-career colleagues
          have limited time, so the course needs to be directly
          beneficial to their learning \& teaching practice.\\
\noindent\textbf{Building a community.} The course needs to facilitate the growing of the community between the attendees and links to the wider community of practice in the UK.\\
\noindent\textbf{Professional alignment.} Preliminary discussions
...
\noindent\textbf{Delivery mode.} At the time of writing the only
          possible mode is online; other modes may be more suitable in the longer term.\\
\noindent\textbf{Prototype course.} All these questions require
...
% \footnote{Supporting work by BCS, The Chartered Institute
% for IT on diversity and inclusion:
% \url{https://www.bcs.org/policy-and-influence/diversity-and-inclusion/}}).
